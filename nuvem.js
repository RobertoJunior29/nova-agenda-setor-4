...
const NOMES_PAPEL={sistema:'Administrador do sistema',admin:'Secretaria Geral',secretario:'Secret\u00e1rio do Setor',secretario_congr:'Secret\u00e1rio de Congrega\u00e7\u00e3o',leitor:'Leitor'};
...
function marcarVersao(){
 ...
 p.id='versaoAgenda';
 p.textContent='Agenda v98 \u00b7 03.08.2026';
 alvo.appendChild(p);
}
