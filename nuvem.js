...
function anoVisivel(){
 const h=document.querySelector('.head h2')||document.querySelector('h2');
 const m=h?(h.textContent||'').match(/(\d{4})/):null;
