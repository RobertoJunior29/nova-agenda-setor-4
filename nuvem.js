...
function marcarVersao(){
 ...
 p.id='versaoAgenda';
 p.textContent='Agenda v87 \u00b7 03.08.2026';
 alvo.appendChild(p);
}
...
/* ---------- departamentos ---------- */
const DEPARTAMENTOS=[{n:'UMADESGA',c:'#b8365c'},{n:'SEMEAR',c:'#2c7a2f'},{n:'DENOC',c:'#3a5bbf'},{n:'DEFAD',c:'#9c5636'},{n:'DEPIN',c:'#7d6a20'},{n:'DEMAD',c:'#0d8074'},{n:'DE3id',c:'#7d4bb0'},{n:'DEFAM',c:'#a3299b'},{n:'DENEC',c:'#1e5f96'},{n:'DIRETORIA',c:'#3f4a50'}];
